...
const (
	...
	P256_BIKE_L1 ID = 0x020a
	P384_BIKE_L3 ID = 0x020b
	P521_BIKE_L5 ID = 0x020c

	P256_HQC_128 ID = 0x020d
	P384_HQC_192 ID = 0x020e
	P521_HQC_256 ID = 0x020f

	P256_Classic_McEliece_348864 ID = 0x0210
	P384_Classic_McEliece_460896 ID = 0x0211
	P521_Classic_McEliece_6688128 ID = 0x0212

	P256_NTRU_HPS_2048_509 ID = 0x0213
	P384_NTRU_HPS_2048_677 ID = 0x0214
	P521_NTRU_HPS_4096_821 ID = 0x0215

	P521_NTRU_HPS_4096_1229 ID = 0x0216

	P384_NTRU_HRSS_701  ID = 0x0217
	P521_NTRU_HRSS_1373 ID = 0x0218

	// Liboqs PQC
	OQS_Kyber512  ID = 0x0219
	OQS_Kyber768  ID = 0x021a
	OQS_Kyber1024 ID = 0x021b

	LightSaber_KEM ID = 0x021c
	Saber_KEM      ID = 0x021d
	FireSaber_KEM  ID = 0x021e

	NTRU_HPS_2048_509 ID = 0x021f
	NTRU_HPS_2048_677 ID = 0x0220
	NTRU_HPS_4096_821 ID = 0x0221

	NTRU_HPS_4096_1229 ID = 0x0222
