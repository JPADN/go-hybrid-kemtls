...
var p256_kyber512 liboqsScheme = liboqsScheme{
	"Kyber512",
	hpke.KEM_P256_HKDF_SHA256.Scheme(),
	oqs.KeyEncapsulation{},
}

var p384_kyber768 liboqsScheme = liboqsScheme{
	"Kyber768",
	hpke.KEM_P384_HKDF_SHA384.Scheme(),
	oqs.KeyEncapsulation{},
}

var p521_kyber1024 liboqsScheme = liboqsScheme{
	"Kyber1024",
...
var p256_lightsaber_kem liboqsScheme = liboqsScheme{
	"LightSaber-KEM",
	hpke.KEM_P256_HKDF_SHA256.Scheme(),
	oqs.KeyEncapsulation{},
}

var p384_saber_kem liboqsScheme = liboqsScheme{
	"Saber-KEM",
	hpke.KEM_P384_HKDF_SHA384.Scheme(),
	oqs.KeyEncapsulation{},
}
...
var p521_firesaber_kem liboqsScheme = liboqsScheme{
	"FireSaber-KEM",
	hpke.KEM_P521_HKDF_SHA512.Scheme(),
	oqs.KeyEncapsulation{},
}
...
var p384_ntru_hps_2048_677 liboqsScheme = liboqsScheme{
	"NTRU-HPS-2048-677",
	hpke.KEM_P384_HKDF_SHA384.Scheme(),
	oqs.KeyEncapsulation{},
}
...
var p521_ntru_hps_4096_821 liboqsScheme = liboqsScheme{
	"NTRU-HPS-4096-821",
	hpke.KEM_P521_HKDF_SHA512.Scheme(),
	oqs.KeyEncapsulation{},
}

var p521_ntru_hps_4096_1229 liboqsScheme = liboqsScheme{
	"NTRU-HPS-4096-1229",
	hpke.KEM_P521_HKDF_SHA512.Scheme(),
	oqs.KeyEncapsulation{},
}

var p384_ntru_hrss_701 liboqsScheme = liboqsScheme{
	"NTRU-HRSS-701",
	hpke.KEM_P384_HKDF_SHA384.Scheme(),
	oqs.KeyEncapsulation{},
}

var p521_ntru_hrss_1373 liboqsScheme = liboqsScheme{
	"NTRU-HRSS-1373",
	hpke.KEM_P521_HKDF_SHA512.Scheme(),
	oqs.KeyEncapsulation{},
}
...
var liboqsSchemeMap = map[ID]liboqsScheme{P256_Kyber512: p256_kyber512, P384_Kyber768: p384_kyber768, P521_Kyber1024: p521_kyber1024,
